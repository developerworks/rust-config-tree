...
Erzeuge Draft-7-JSON-Schemas fuer die Root-Konfiguration und verschachtelte
Abschnitte:
...
Felder, die in die Root-Datei gehoeren; verschachtelte Abschnittsfelder werden
...
untergeordneten Abschnittsfelder. Aufgeteilte YAML-Abschnittsvorlagen binden
...
## Automatische Abschnittsaufteilung

Wenn eine Quelldatei keine Includes hat, kann die Crate Include-Ziele aus
verschachtelten Schemaabschnitten ableiten. Fuer ein Schema mit einem Abschnitt
...
nur den Abschnitt `server`. Verschachtelte Abschnitte werden rekursiv
aufgeteilt.
